...
#ifndef AGENTRT_SCHEDULER_CORE_H
#define AGENTRT_SCHEDULER_CORE_H
...
typedef struct task_info_core {
    ...
    /** @brief 任务状态 */
    volatile agentrt_task_state_t state;
 ...
 * @return 哈希桶索引
 */
static inline size_t task_hash_core(agentrt_task_id_t id)
{
...
#endif /* AGENTRT_SCHEDULER_CORE_H */
