...
#ifndef AGENTRT_AGENTRT_H
#define AGENTRT_AGENTRT_H
 ...
 */
#define AGENTRT_CORE_API_VERSION_MAJOR 1
#define AGENTRT_CORE_API_VERSION_MINOR 0
#define AGENTRT_CORE_API_VERSION_PATCH 0
 ...
 * @note 多次调用会返回 AGENTRT_SUCCESS（幂等操作）
 *
 * @see agentrt_core_shutdown()
 */
