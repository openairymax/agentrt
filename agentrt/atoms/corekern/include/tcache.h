...
#ifndef AGENTRT_COREKERN_TCACHE_H
#define AGENTRT_COREKERN_TCACHE_H
 ...
 */
AGENTRT_API agentrt_tcache_t *agentrt_tcache_create(
 ...
 * @param tcache 缓存句柄
 */
AGENTRT_API void agentrt_tcache_destroy(agentrt_tcache_t *tcache);
 ...
 */
AGENTRT_API void *agentrt_tcache_alloc(agentrt_tcache_t *tcache);
 ...
 * @param ptr 要释放的指针
 */
AGENTRT_API void agentrt_tcache_free(agentrt_tcache_t *tcache, void *ptr);
 ...
 */
AGENTRT_API void agentrt_tcache_get_stats(agentrt_tcache_t *tcache,
                                           agentrt_tcache_stats_t *out_stats);
 ...
 * @param tcache 缓存句柄
 */
AGENTRT_API void agentrt_tcache_reset_stats(agentrt_tcache_t *tcache);

#ifdef __cplusplus
}
#endif

#endif /* AGENTRT_COREKERN_TCACHE_H */
