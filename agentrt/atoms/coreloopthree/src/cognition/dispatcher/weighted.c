 ...
 */
static agentrt_error_t weighted_select(const agentrt_task_node_t *task, const void **candidates,
...
agentrt_dispatching_weighted_create(const weighted_config_t *config, void *registry_ctx,
