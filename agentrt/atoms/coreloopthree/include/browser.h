...
#ifndef AGENTRT_CORELOOPTHREE_BROWSER_H
#define AGENTRT_CORELOOPTHREE_BROWSER_H
 ...
 * @threadsafe 否
 */
AGENTRT_API agentrt_error_t agentrt_browser_fill_form(void *conn, const char *selector,
 ...
 * @threadsafe 否
 */
AGENTRT_API agentrt_error_t agentrt_browser_wait_for_element(void *conn, const char *selector,
                                                             size_t selector_len,
...
#endif /* AGENTRT_CORELOOPTHREE_BROWSER_H */
