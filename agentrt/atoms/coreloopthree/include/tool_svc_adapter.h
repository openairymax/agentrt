 ...
 *
 *   // 3. 注入到认知引擎
 *   agentrt_cognition_set_tool_service(engine, svc);
 *
 *   // 4. 关闭时销毁
...
#ifndef AGENTRT_CORELOOPTHREE_TOOL_SVC_ADAPTER_H
#define AGENTRT_CORELOOPTHREE_TOOL_SVC_ADAPTER_H
...
#endif /* AGENTRT_CORELOOPTHREE_TOOL_SVC_ADAPTER_H */