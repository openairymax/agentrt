 ...
 *   agentrt_cognition_set_llm_adapter(engine, adapter);
 *
 *   // 3. 关闭时销毁
...
#ifndef AGENTRT_CORELOOPTHREE_LLM_SVC_ADAPTER_H
#define AGENTRT_CORELOOPTHREE_LLM_SVC_ADAPTER_H
 ...
 * 始终返回 NULL。应改用 agentrt_cognition_set_llm_adapter() 注入 IPC adapter。
 *
 * @param adapter 适配器句柄
 * @return 始终返回 NULL
 *
...
#endif /* AGENTRT_CORELOOPTHREE_LLM_SVC_ADAPTER_H */