...
#ifndef AGENTOS_REFCOUNT_H
#define AGENTOS_REFCOUNT_H
 ...
 * @threadsafe 是
 */
AGENTOS_API void *refcount_alloc(size_t size, void (*deleter)(refcounted_t *));
 ...
 * @threadsafe 是
 */
AGENTOS_API uint32_t refcount_retain(refcounted_t *obj);
 ...
 * @threadsafe 是
 */
AGENTOS_API uint32_t refcount_release(refcounted_t *obj);
 ...
 * @threadsafe 是（原子读取）
 */
AGENTOS_API uint32_t refcount_get(refcounted_t *obj);

#ifdef __cplusplus
}
#endif

#endif /* AGENTOS_REFCOUNT_H */
