...
AGENTOS_API agentos_error_t sc_stream_critic_create(const sc_config_t *config,
...
AGENTOS_API agentos_error_t sc_intent_classifier(sc_stream_critic_t *critic, const char *input,
...
AGENTOS_API agentos_error_t sc_stream_validator(sc_stream_critic_t *critic, const char *content,
                                                size_t content_len,
...
AGENTOS_API agentos_error_t sc_output_corrector(sc_stream_critic_t *critic, const char *raw_output,
...
AGENTOS_API agentos_error_t sc_memory_confirmer(sc_stream_critic_t *critic, const char *output,
                                                size_t output_len,
                                                const sc_intent_result_t *intent_context,
...
AGENTOS_API agentos_error_t sc_stream_critic_pipeline(
    ...
    size_t raw_output_len, agentos_memory_engine_t *memory_engine, char **out_final_output,
...
AGENTOS_API agentos_error_t sc_stream_critic_get_stats(const sc_stream_critic_t *critic,
