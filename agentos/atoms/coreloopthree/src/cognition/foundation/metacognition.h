 ...
 * @brief 关联思考链路（用于回调通知）
 */
AGENTOS_API void agentos_mc_set_chain(agentos_metacognition_t *mc, agentos_thinking_chain_t *chain);
 ...
 * @return AGENTOS_SUCCESS 或错误码
 */
AGENTOS_API agentos_error_t agentos_mc_evaluate_step(agentos_metacognition_t *mc,
 ...
 * 用于流式批判场景，比完整评估更快。
 */
AGENTOS_API agentos_error_t agentos_mc_evaluate_quick(agentos_metacognition_t *mc,
                                                      agentos_thinking_step_t *step,
...
AGENTOS_API agentos_error_t agentos_mc_apply_correction(
    ...
    agentos_error_t (*corrector_fn)(const char *input, size_t input_len, char **output,
 ...
 */
AGENTOS_API int agentos_mc_should_self_correct(agentos_metacognition_t *mc,
 ...
 * 则降低其未来报告的该置信度值。
 */
AGENTOS_API float agentos_mc_calibrate_confidence(agentos_metacognition_t *mc,
 ...
 */
AGENTOS_API agentos_error_t agentos_mc_feedback(agentos_metacognition_t *mc,
 ...
 */
AGENTOS_API agentos_error_t agentos_mc_stats(agentos_metacognition_t *mc, char **out_json);

/**
 * @brief 获取最近的N条评估记录
 */
AGENTOS_API agentos_error_t agentos_mc_get_history(agentos_metacognition_t *mc, size_t count,
 ...
 * @return AGENTOS_SUCCESS 或错误码
 */
AGENTOS_API agentos_error_t agentos_mc_detect_patterns(agentos_metacognition_t *mc,
 ...
 * @return AGENTOS_SUCCESS 或错误码
 */
AGENTOS_API agentos_error_t agentos_mc_learn_best_strategy(agentos_metacognition_t *mc,
 ...
 */
AGENTOS_API int agentos_mc_preemptive_check(agentos_metacognition_t *mc, tc_step_type_t step_type,
 ...
 * @return AGENTOS_SUCCESS 或错误码
 */
AGENTOS_API agentos_error_t agentos_mc_record_strategy_result(agentos_metacognition_t *mc,
                                                              const char *pattern_key,
