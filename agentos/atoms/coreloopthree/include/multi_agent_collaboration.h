...
typedef int (*mac_task_delegate_fn)(struct mac_framework_s* fw,
                                      const mac_collab_task_t* task,
                                      const mac_agent_info_t* agent,
                                      void* user_data);
typedef int (*mac_result_aggregate_fn)(struct mac_framework_s* fw,
                                         const char* group_id,
                                         const char* task_id,
                                         const char** results,
                                         size_t result_count,
                                         char** aggregated_result,
                                         void* user_data);
...
AGENTOS_API int mac_framework_collect_results(mac_framework_t* fw, const char* group_id,
                                              const char* task_id, char*** results, size_t* result_count);
