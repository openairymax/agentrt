...
typedef struct agentos_memory_provider {
    ...
    agentos_error_t (*write_raw)(
        struct agentos_memory_provider* provider,
        const void* data, size_t len,
        const char* metadata_json,
        char** out_record_id);

    agentos_error_t (*get_raw)(
        struct agentos_memory_provider* provider,
        const char* record_id,
        void** out_data, size_t* out_len);

    agentos_error_t (*delete_raw)(
        struct agentos_memory_provider* provider,
        const char* record_id);

    agentos_error_t (*query)(
        struct agentos_memory_provider* provider,
    ...
    agentos_error_t (*evolve)(
        struct agentos_memory_provider* provider,
        int force);

    agentos_error_t (*forget)(
        struct agentos_memory_provider* provider);

    agentos_error_t (*stats)(
        struct agentos_memory_provider* provider,
        agentos_memory_stats_t* out_stats);

    agentos_error_t (*mount)(
        struct agentos_memory_provider* provider,
        const char* record_id,
        const char* context);
