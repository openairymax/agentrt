...
protocol_handler_route_result_t protocol_handler_router_register(
    protocol_handler_router_t router,
    const char* protocol_name,
    void* handler_context);
protocol_handler_route_result_t protocol_handler_router_route(
    protocol_handler_router_t router,
