...
protocol_registry_t *proto_registry_create(void)
{
    protocol_registry_t *registry =
        (protocol_registry_t *)AGENTOS_CALLOC(1, sizeof(protocol_registry_t));
    if (!registry)
        return NULL;
...
size_t proto_registry_list_all(protocol_registry_t *registry, proto_registry_entry_t **entries)
{
    ...
    *entries = (proto_registry_entry_t *)AGENTOS_CALLOC(registry->entry_count,
                                       ...
                                       proto_registry_entry_t **entries)
{
    ...
    *entries = (proto_registry_entry_t *)AGENTOS_CALLOC(count, sizeof(proto_registry_entry_t));
    if (!*entries)
        return 0;
