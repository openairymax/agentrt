...
#define AGENTOS_LLM_ROUTER_CONTEXT_H
...
static inline void router_fill_result(llm_route_result_t *result,
                                       ...
                                       size_t output_tokens)
{
    AGENTOS_STRNCPY_TERM(result->provider_name, ep->provider_name,
                         sizeof(result->provider_name));
    AGENTOS_STRNCPY_TERM(result->model_name, ep->model_name,
                         sizeof(result->model_name));
    AGENTOS_STRNCPY_TERM(result->endpoint, ep->endpoint,
...
{
    if (!fallback) return;
    AGENTOS_STRNCPY_TERM(result->fallback_provider,
                         fallback->provider_name,
                         sizeof(result->fallback_provider));
    AGENTOS_STRNCPY_TERM(result->fallback_model,
                         fallback->model_name,
...
#endif /* AGENTOS_LLM_ROUTER_CONTEXT_H */