...
typedef void (*agentos_checkpoint_hook_fn)(const char *task_id, const char *state_json, void *user_data);
...
AGENTOS_API agentos_error_t agentos_checkpoint_list(const char *task_id, agentos_task_checkpoint_t ***out_checkpoints,
                                                    size_t *out_count);
AGENTOS_API agentos_error_t agentos_checkpoint_get_stats(agentos_checkpoint_stats_t *out_stats);
AGENTOS_API agentos_error_t agentos_checkpoint_verify(const agentos_task_checkpoint_t *checkpoint, bool *is_valid);
...
AGENTOS_API agentos_error_t agentos_checkpoint_set_auto_hook(agentos_checkpoint_hook_fn hook, void *user_data,
