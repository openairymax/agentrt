...
typedef void (*agentos_checkpoint_hook_fn)(
    const char* task_id,
    const char* state_json,
    void* user_data);

AGENTOS_API agentos_error_t agentos_checkpoint_create(
    const char* task_id,
...
AGENTOS_API agentos_error_t agentos_checkpoint_restore(
    const char* task_id,
    uint64_t sequence_num,
    agentos_task_checkpoint_t** out_checkpoint);
AGENTOS_API agentos_error_t agentos_checkpoint_delete(const char* task_id, uint64_t sequence_num);
AGENTOS_API agentos_error_t agentos_checkpoint_list(
    const char* task_id,
...
AGENTOS_API agentos_error_t agentos_checkpoint_verify(
...
AGENTOS_API agentos_error_t agentos_checkpoint_set_auto_hook(
