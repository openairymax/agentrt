...
#ifndef AGENTOS_PLUGIN_DISCOVERY_H
#define AGENTOS_PLUGIN_DISCOVERY_H
...
typedef struct {
    ...
    uint32_t min_agentos_version;           /**< 最低版本要求 */
...
#endif /* AGENTOS_PLUGIN_DISCOVERY_H */