...
int hook_audit_handler_register(void)
{
    ...
    if (agentos_hook_register(AUDIT_HANDLER_ERROR_NAME,
                               HOOK_TYPE_ON_ERROR,
    ...
    if (agentos_hook_register(AUDIT_HANDLER_TOOL_NAME,
                               HOOK_TYPE_POST_TOOL,
...
{
    agentos_hook_unregister(AUDIT_HANDLER_ERROR_NAME);
    agentos_hook_unregister(AUDIT_HANDLER_TOOL_NAME);
}
