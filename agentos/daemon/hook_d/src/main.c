...
int main(int argc, char *argv[]) {
    ...
    fprintf(stderr, "[hook_d] Hook daemon started (stub)\n");

    g_bsd = daemon_bootstrap_sd_start("hook_d", "hook", AGENTOS_RUNTIME_DIR "/hook.sock",
                                      0, "hook,core", 0);
    g_bipc = daemon_bootstrap_ipc_start("hook_d", "hook", AGENTOS_RUNTIME_DIR "/hook.sock",
