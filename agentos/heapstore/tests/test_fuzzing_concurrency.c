...
static void test_concurrent_init_shutdown_race(void)
{
    ...
    for (int round = 0; round < 100; round++) {
        heapstore_config_t config = {.root_path = AGENTOS_TMP_DIR "/agentos_heapstore_race_test",
                                     .max_log_size_mb = 10,
...
int main(int argc, char *argv[])
{
    ...
    heapstore_config_t config = {.root_path = AGENTOS_TMP_DIR "/agentos_heapstore_fuzz_test",
                                 .max_log_size_mb = 50,
