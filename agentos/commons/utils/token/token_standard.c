 ...
 * @return 0成功，-1失败
 */
static int utf8_decode_code_point(const char* text, size_t i, size_t length,
                                   uint32_t* code_point, size_t* bytes_consumed) {
    if (!text || !code_point || !bytes_consumed) return -1;
    ...
    if (c < 0x80) {
        ...
        *bytes_consumed = 2;
        ...
        if ((n1 & 0xC0) != 0x80 || (n2 & 0xC0) != 0x80) return -1;
        if (c == 0xE0 && n1 < 0xA0) return -1;
        if (c == 0xED && n1 > 0x9F) return -1;
        ...
        *bytes_consumed = 3;
        ...
        if ((n1 & 0xC0) != 0x80 || (n2 & 0xC0) != 0x80 || (n3 & 0xC0) != 0x80) return -1;
        if (c == 0xF0 && n1 < 0x90) return -1;
        if (c == 0xF4 && n1 > 0x8F) return -1;
...
static int is_cjk_code_point(uint32_t code_point) {
    if (code_point >= 0x4E00 && code_point <= 0x9FFF) return 1;
    if (code_point >= 0x3400 && code_point <= 0x4DBF) return 1;
    if (code_point >= 0x20000 && code_point <= 0x2A6DF) return 1;
    if (code_point >= 0x2A700 && code_point <= 0x2B73F) return 1;
    if (code_point >= 0x2B740 && code_point <= 0x2B81F) return 1;
    if (code_point >= 0x2B820 && code_point <= 0x2CEAF) return 1;
    if (code_point >= 0x2CEB0 && code_point <= 0x2EBEF) return 1;
    if (code_point >= 0x30000 && code_point <= 0x3134F) return 1;
    if (code_point >= 0x31350 && code_point <= 0x323AF) return 1;
    if (code_point >= 0xF900 && code_point <= 0xFAFF) return 1;
    if (code_point >= 0x2F800 && code_point <= 0x2FA1F) return 1;
    if (code_point >= 0x3000 && code_point <= 0x303F) return 1;
    if (code_point >= 0x3040 && code_point <= 0x309F) return 1;
    if (code_point >= 0x30A0 && code_point <= 0x30FF) return 1;
    if (code_point >= 0xAC00 && code_point <= 0xD7AF) return 1;
    if (code_point >= 0xFF00 && code_point <= 0xFFEF) return 1;
    return 0;
}
