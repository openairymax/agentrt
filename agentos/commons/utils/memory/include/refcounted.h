...
#ifndef AGENTOS_REFCOUNTED_H
#define AGENTOS_REFCOUNTED_H
...
static inline void *refcount_alloc(size_t obj_size, void (*deleter)(void *obj))
{
    ...
    refcounted_t *rc = (refcounted_t *)AGENTOS_CALLOC(1, obj_size);
    if (!rc) return NULL;
 ...
 */
#define AGENTOS_REFCOUNTED_HEADER refcounted_t _rc
