...
/* 向后兼容别名 */
#define TASK_STATUS_PENDING    AGENTOS_TASK_PENDING
#define TASK_STATUS_RUNNING    AGENTOS_TASK_RUNNING
#define TASK_STATUS_SUCCEEDED  AGENTOS_TASK_SUCCEEDED
#define TASK_STATUS_FAILED     AGENTOS_TASK_FAILED
#define TASK_STATUS_CANCELLED  AGENTOS_TASK_CANCELLED
#define TASK_STATUS_TIMEOUT   AGENTOS_TASK_TIMEOUT
#define TASK_STATUS_RETRYING   AGENTOS_TASK_RETRYING
#endif
...
#define AGENTOS_MAKE_VERSION(maj, min, pat) (((maj) << 24) | ((min) << 16) | ((pat) << 8))
#endif
