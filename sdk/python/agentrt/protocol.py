...
class ProtocolConfig:
    ...
    endpoint: str = field(default_factory=lambda: os.environ.get("AGENTRT_ENDPOINT", "http://127.0.0.1:18789"))
    ...
    def from_env(cls) -> "ProtocolConfig":
        ...
        import os
        return cls(
            endpoint=os.getenv("AGENTRT_ENDPOINT", cls.endpoint),
            api_key=os.getenv("AGENTRT_API_KEY", cls.api_key),
            timeout=int(os.getenv("AGENTRT_TIMEOUT", str(cls.timeout))),
        )
